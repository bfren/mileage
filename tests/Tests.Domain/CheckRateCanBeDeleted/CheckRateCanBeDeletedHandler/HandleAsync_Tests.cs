...
{
	private sealed class Setup : Setup<RateId, CheckRateCanBeDeletedQuery, CheckRateCanBeDeletedHandler>
	{
		...
		internal override CheckRateCanBeDeletedQuery GetQuery(AuthUserId? userId = null, RateId? entityId = null)
		{
