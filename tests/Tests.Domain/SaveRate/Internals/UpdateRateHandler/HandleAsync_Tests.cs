...
{
	private sealed class Setup : Setup<IRateRepository, RateEntity, RateId, UpdateRateHandler>
	{
	...
	public async Task Calls_Log_Vrb__With_Query()
	{
		...
		var command = new UpdateRateCommand(IdGen.LongId<RateId>(), Rnd.Lng, Rnd.Flt, Rnd.Flip);
