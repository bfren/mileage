...
{
	private sealed class Setup : Setup<UpdateJourneyRateCommand, UpdateJourneyRateHandler>
	{
		...
		internal override UpdateJourneyRateCommand GetCommand(AuthUserId? userId = null)
		{
			...
			return new(userId, IdGen.LongId<JourneyId>(), Rnd.Lng, IdGen.LongId<RateId>());
		}
