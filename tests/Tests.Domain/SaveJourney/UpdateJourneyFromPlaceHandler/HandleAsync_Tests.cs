...
{
	private sealed class Setup : Setup<UpdateJourneyFromPlaceCommand, UpdateJourneyFromPlaceHandler>
	{
		...
		internal override UpdateJourneyFromPlaceCommand GetCommand(AuthUserId? userId = null)
		{
			...
			return new(userId, IdGen.LongId<JourneyId>(), Rnd.Lng, IdGen.LongId<PlaceId>());
		}
